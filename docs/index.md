...
#  text: Hello, welcome to my site.
  tagline: Hi, my name is Boulama. I am a self taught software engineer and entrepreneur currently studying Aerospace Engineering at the Florida Institute of Technology. I work and study the intersection of machine learning, aerospace and material engineering.
  actions:
    - theme: brand
      text: Blog
      link: /blog/
